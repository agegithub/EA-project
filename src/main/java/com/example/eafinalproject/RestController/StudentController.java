...
import com.example.eafinalproject.service.StudentService;
...
//    }
    ...
    public String updateStudent(@PathVariable Long id,
        ...
        existingStudent.setMailingAddress(student.getMailingAddress());
        existingStudent.setHomeAddress(student.getHomeAddress());
        existingStudent.setRegistrationRequestList(student.getRegistrationRequestList());
